/**
 * Label mappings for admin action log
 */
...
export const actionTypeLabels: Record<string, string> = {
  ...
  AGENT_TERMINATE: 'Terminate Agent Session',
  ...
  DENY_POLICY_REMOVAL_APPROVE: 'Approve DENY Policy Removal',
  DENY_POLICY_REMOVAL_DENY: 'Deny DENY Policy Removal',
  ...
  // Webhook actions
  WEBHOOK_ENDPOINT_CREATE: 'Create Webhook',
  WEBHOOK_ENDPOINT_UPDATE: 'Update Webhook',
  WEBHOOK_ENDPOINT_DELETE: 'Delete Webhook',
  ...
  WORKSPACE_MEMBER_ROLE_UPDATE: 'Update Member Role',
  WORKSPACE_CHAT_SETTINGS_CREATE: 'Create Chat Settings',
  WORKSPACE_CHAT_SETTINGS_UPDATE: 'Update Chat Settings',
  ...
  POLICY_EXCEPTION_CREATE: 'Create Policy Exception',
  POLICY_EXCEPTION_APPROVE: 'Approve Policy Exception',
  POLICY_EXCEPTION_DENY: 'Deny Policy Exception',
  POLICY_EXCEPTION_WITHDRAW: 'Withdraw Policy Exception',

  // Owner recovery actions
  OWNER_RECOVERY_CREATE: 'Create Owner Recovery',
  OWNER_RECOVERY_CANCEL: 'Cancel Owner Recovery',
  OWNER_RECOVERY_DENY: 'Deny Owner Recovery',
...
export const resourceTypeLabels: Record<string, string> = {
  ...
  AGENT: 'Agent',
  PUBLISHER: 'Publisher',
  USER_MCP_CONFIG: 'User MCP Config',
  PERMISSION_REQUEST: 'Permission Request',
  ORGANIZATION: 'Organization',
  SENSITIVE_FLAG: 'Sensitive Flag',
  SENSITIVE_OVERRIDE: 'Sensitive Override',
  SENSITIVE_APPROVAL: 'Sensitive Approval',
  WEBHOOK_ENDPOINT: 'Webhook Endpoint',
  INTEGRATION: 'Integration',
  A2A_CREDENTIAL: 'A2A Credential',
  GLOBAL_VAR_NAMESPACE: 'Variable Namespace',
  GLOBAL_VAR_FIELD: 'Variable Field',
  WORKSPACE: 'Workspace',
  WORKSPACE_MEMBER: 'Workspace Member',
  WORKSPACE_CHAT_SETTINGS: 'Chat Settings',
  ORG_OWNER: 'Organization Owner',
  OWNERSHIP_TRANSFER: 'Ownership Transfer',
  POLICY_PROPOSAL: 'Policy Proposal',
  POLICY_EXCEPTION: 'Policy Exception',
  OWNER_RECOVERY: 'Owner Recovery',
  MCP_CONFIRMATION: 'MCP Confirmation',
};
